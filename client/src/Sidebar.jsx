    ...
    >
      ...
      <div className="states-markets indicator-container">
        ...
        <div className="stat-row">
          ...
          <div className="stats">
            <div className="stat-label">Ratio of female to male labor force participation</div>
            <div className="stat-value">
              {countryIndicatorData?.length > 0
                ? formatPercentage(
        ...
        <div className="stat-row">
          ...
          <div className="stats">
            <div className="stat-label">Proportion of seats held by women in parliaments</div>
            <div className="stat-value">
              {countryIndicatorData?.length > 0
                ? formatPercentage(
