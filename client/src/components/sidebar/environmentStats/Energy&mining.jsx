  ...
  return (
    <div className="energy-mining indicator-container">
      ...
      <div className="stat-row">
        <div className="stats">
          <div className="stat-label">Energy intensity level of primary energy (MJ/$2017 PPP GDP)</div>
        ...
        <div className="stats">
          <div className="stat-label">Renewable energy consumption (% of total final energy consumption)</div>
          <div className="stat-value">
            {environmentIndicatorData?.length > 0
              ? formatPercentage(
        ...
        <div className="stats">
          <div className="stat-label">Renewable electricity output (% of total electricity output)</div>
          <div className="stat-value">
            {environmentIndicatorData?.length > 0
              ? formatPercentage(
      ...
      <div className="stat-row">
        <div className="stats">
          <div className="stat-label">Access to electricity (% of population)</div>
          <div className="stat-value">
            {environmentIndicatorData?.length > 0
              ? formatPercentage(
        ...
        <div className="stats">
          <div className="stat-label">Access to clean fuels and technologies for cooking (% of population)</div>
          <div className="stat-value">
            {environmentIndicatorData?.length > 0
              ? formatPercentage(
